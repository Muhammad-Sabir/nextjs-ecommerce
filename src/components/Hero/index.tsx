...
export default function Hero() {
  return (
    <div className="mx-auto my-8 flex h-fit flex-col items-center justify-center gap-4 rounded-xl bg-gradient-to-r from-blue-900 to-primaryBlue p-4 text-center text-bgWhite md:p-16 ">
