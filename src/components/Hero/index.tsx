...
export default function Hero() {
  return (
    <div className="my-8 flex h-[50vh] flex-col items-center justify-center gap-4 rounded-xl bg-gradient-to-r from-blue-900 to-primaryBlue p-16 text-center text-bgWhite ">
